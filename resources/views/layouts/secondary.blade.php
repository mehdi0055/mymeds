...
<head>
    ...
    <link rel="icon" href="{{ asset('primary/assets/img/favicon.ico') }}" type="image/x-icon">
...
<body class="theme-cyan">
    ...
    <div class="page-loader-wrapper">
        <div class="loader">
            <div class="m-t-30">
                <img src="{{ asset('landing/assets/img/logo-.png') }}" width="128" height="128" alt="MyMed">
            </div>
            <p>Please wait...</p>
        </div>
    </div>
        ...
        <nav class="navbar navbar-fixed-top">
            <div class="container-fluid">
                ...
                <div class="navbar-brand">
                    <a href="{{ Auth::user()->utype == "ADM" ? route('admin-dashboard') : route('user-dashboard') }}">
                        <img src="{{ asset('landing/assets/img/logo.png') }}" width="32" height="32" alt="My MED" class="img-responsive logo"></a>
                </div>
                <div class="navbar-right">
                    ...
                    <div id="navbar-menu">
                        <ul class="nav navbar-nav">
                            ...
                            <li>
                                <a href=#" class="icon-menu d-none d-sm-block"><i
                            ...
                            <li>
                                ...
                                <a href="{{ route('logout') }}" onclick="event.preventDefault();$('#logout-form').submit();" class="icon-menu"><i class="icon-login"></i></a>
                            </li>
                        </ul>
                    </div>
                </div>
        ...
        <div id="left-sidebar" class="sidebar">
            <div class="sidebar-scroll">
                <div class="user-account">
                    <img src="{{ Auth::user()->profile_photo_path ?  asset('primary/assets/images/user.png') : asset('primary/assets/images/default-user.png') }}" class="rounded-circle user-photo" alt="User Profile Picture">
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-right account">
                            ...
                            <li><a href="app-inbox.html"><i class="icon-envelope-open"></i>{{ __('language.messages') }}</a></li>
                            <li><a href="javascript:void(0);"><i class="icon-settings"></i>{{ __('language.settings') }}</a></li>
                            <li class="divider"></li>
                            <li><a href="{{ route('logout') }}" onclick="event.preventDefault();$('#logout-form').submit();"><i class="icon-power"></i>{{ __('language.logout') }}</a></li>
                        </ul>
                    </div>
                    <hr>
                    ...
                    <div class="tab-pane p-l-15 p-r-15" id="Chat">
                        ...
                        <ul class="right_chat list-unstyled">
                            ...
                            <li class="offline">
                                <a href="javascript:void(0);">
                                    <div class="media">
                                        <img class="media-object " src="{{asset('primary/assets/images/xs/avatar1.jpg') }}" alt="">
                                        <div class="media-body">
